...
RENTCAST_API_KEY = os.getenv("RENTAL_DASHBOARD_RENTCAST_API_KEY") or os.getenv("RENTCAST_API_KEY", "")
RENTCAST_ENABLED = os.getenv("RENTAL_DASHBOARD_RENTCAST_ENABLED", "").strip().lower() in {"1", "true", "yes", "on"}
RENTCAST_API_BASE_URL = os.getenv("RENTAL_DASHBOARD_RENTCAST_API_BASE_URL", "https://api.rentcast.io/v1")
RENTCAST_TIMEOUT_SECONDS = float(os.getenv("RENTAL_DASHBOARD_RENTCAST_TIMEOUT_SECONDS", "12"))
